...
joule_per_eV = 1.6021766E-19;
joule_per_keV = joule_per_eV * 1E3;
joule_per_MeV = joule_per_eV * 1E6;
joule_per_GeV = joule_per_eV * 1E9;

//Forces
function a_c(distance) { //Acceleration due to Coloumb force
	return (q_e * q_e) / (distance * distance) / m_p / (4 * Math.PI * e_0);
}
...
function critical_energy(width) {
	return Math.abs(  0.5 * (q_e * q_e) / (4 * Math.PI * e_0) * ( (1.0 / 5E-15) - (1.0 / width) )  ) / joule_per_MeV;
}
