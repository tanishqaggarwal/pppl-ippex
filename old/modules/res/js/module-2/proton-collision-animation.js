...
function protoncollision_setup() {
	...
	particlewidth = 3;
	$("#energyslide").attr("max", (3.0 / 2) * critical_energy(2 * particlewidth / distance_scale));

	var dottexture = new PIXI.RenderTexture(protoncollision_renderer, 2 * particlewidth, 2 * particlewidth);
	...
	collision_proton1 = new PIXI.Sprite(dottexture);
	collision_proton2 = new PIXI.Sprite(dottexture);
