function setup() {
        ...
        id = loader.resources["images/vt/ippexsprites.json"].textures;
        idM = loaderModals.resources["images/vt/ippexspritesModals.json"].textures;
        idGM = loaderModals.resources["images/vt/ippexspritesGlobalModals.json"].textures;


      //  window1 = new PIXI.Sprite(PIXI.loader.resources["/tokamak/img/window.png"].texture);
        ...
        introContinueBut = new PIXI.Sprite(id["continueButOff.png"]);
        introContinueBut.position.set(464.1,550);
        startManual.addChild(introContinueBut);

        buttonizeContinue(introContinueBut);
        ...
        bottomLines.position.set(117.573,203.754);
...
//        console.log(innerWallDanger.height);
       ...
       //Antenna code
        ...
        antennaPos = [179.83,224.62,162.8,104.5];
        ...
        wave.position.set(torCenter.x-255,torCenter.y);
...

        {
            ...
            if (i % 2 == 0) {
                ...
                var dude = new PIXI.Sprite(id["particleblue.png"]);
            };
        ...
        controlBox.position.set(15,506.602);
        controls.addChild(controlBox);
        ...
        topControls.addChild(densButBox);
        ...
        muteText = new PIXI.Text("mute");
        muteText.style = {fill:"white", font:"15px calibri"};
        // muteText.text = "Density: ";
        muteText.anchor.set(1,1);
        muteText.position.set(contPos.box.pos[0] + 38  , contPos.box.pos[1] + 105);
        controls.addChild(muteText);




        topLines = new PIXI.Sprite(id["topLines.png"]);
        topLines.position.set(631.909,215.386);
        ...
        densLimitText.txt = "densLimit"
        buttonizeModal(densLimitText);
        ...
        betaLimitText.txt = "betaLimit"
        buttonizeModal(betaLimitText);
        ...
        exchangerBottom = new PIXI.Sprite(id["exchangerBottom.png"]);
        exchangerBottom.position.set(134.013,111.124);
        exchangerBottomContainer.addChild(exchangerBottom);

        exchangerElements = new PIXI.Sprite(id["exchangerElements.png"]);
        exchangerElements.position.set(43.978,101.9);
        exchangerElementsContainer.addChild(exchangerElements);
 

        tritiumRed = new PIXI.Sprite(id["tritiumRed.png"]);
        tritiumRed.position.set(361.9,248.2);
        exchangerElementsContainer.addChild(tritiumRed);
        tritiumRed.visible = false;

        heatRed = new PIXI.Sprite(id["heatRed.png"]);
        heatRed.position.set(576.5,248.2);
        exchangerElementsContainer.addChild(heatRed);
        heatRed.visible = false;

        steamRed = new PIXI.Sprite(id["steamRed.png"]);
        steamRed.position.set(797.5,248.2);
        exchangerElementsContainer.addChild(steamRed);
        ...
        redBlanket.position.set(43.978,193.111);
        exchangerElementsContainer.addChild(redBlanket);
        ...
        citySprite = new PIXI.Sprite(id["newcity.png"]);
        citySprite.position.set(17.5,193.1);
        citySubcontainer.addChild(citySprite);
        citySprite.visible = true;

        citySprite2 = new PIXI.Sprite(id["newcity2.png"]);
        citySprite2.position.set(627.519,479.188);
        citySubcontainer.addChild(citySprite2);
        citySprite2.visible = true;

        cityElectricity = new PIXI.Sprite(id["electricity.png"]);
        cityElectricity.position.set(195.053,421.423);
        citySubcontainer.addChild(cityElectricity);
        cityElectricity.visible = true;

        //  cityRed = new PIXI.Sprite(id["cityRed.png"]);
        cityRed = new PIXI.Sprite(id["cityRedNew.png"]);
        cityRed.position.set(405.3,179);
        citySubcontainer.addChild(cityRed);
        cityRed.visible = false;


        lightWindows();
  //        cityWindowsTexture = PIXI.utils.TextureCache["tokamak/img/window.png"];
  //        cityWindows = new PIXI.Sprite(id["window.png"]);
  //        cityWindows.position.set(898, 389);//(507.3,362);
  //        citySubcontainer.addChild(cityWindows);
  //        cityWindows.visible = true;


    //      cityWindows1 = new PIXI.Sprite(id["window.png"]);
    //      cityWindows1.position.set(521.3,362);
    //      citySubcontainer.addChild(cityWindows1);
    //      cityWindows1.visible = true;
        ...
        running = new Howl({
          urls: ['sounds/vt/running.wav'],
          loop:true
        });

        turnon = new Howl({
            urls : ['sounds/vt/turnon.mp3'],
            volume : 0.4
        });

        explosion3 = new Howl({
            urls : ['sounds/vt/explosion3.wav']
        });

        explosion = new Howl({
            urls : ['sounds/vt/explosion.wav']
        });

        wilhelm = new Howl({
            urls : ['sounds/vt/wilhelm.wav']
        });

        alarm = new Howl({
            urls : ['sounds/vt/alarm2.wav'],
            loop : true,
            volume : 0.1
        });

        select = new Howl({
            urls : ['sounds/vt/select.wav']
        });

        click = new Howl({
            urls : ['sounds/vt/click.mp3']
        });

        shutdown = new Howl({
            urls : ['sounds/vt/shutdown.wav']
        });
