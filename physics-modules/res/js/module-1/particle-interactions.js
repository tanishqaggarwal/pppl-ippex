...
function pi_setup() {
	central_electron = new PIXI.Sprite(circle_texture(pi_particlewidth, pi_renderer));
...
$("#particle-interaction-canvas").mouseup(function(e) {
	...
	if (particletype == "electron")
		particle = new PIXI.Sprite(circle_texture(pi_particlewidth, pi_renderer));
	else
		particle = new PIXI.Sprite(circle_texture(pi_particlewidth, pi_renderer, 0xff0000));
