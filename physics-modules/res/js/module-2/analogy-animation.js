PIXI.loader.add([
	"/physics-modules/res/images/module-2/spring.png"
]).load(protons_setup);
...
function protons_setup() {
	...
	analogy_spring = new PIXI.Sprite(PIXI.loader.resources["/physics-modules/res/images/module-2/spring.png"].texture);
...
function reset_initial_values(currentstage, add_delay) {
	...
	if (add_delay) {
		for (var i = 0; i < 1E8; i++) {
			//do nothing except take up CPU cycles
		}
	}
}
